...
export class Model {
  ...
  public save(value: object, callback: string | null): void {
    Database.executeQuery(
      new Query(this.name, QueryType.InsertOne, value, callback)
    );
  }
  ...
  public findOne(conditions: object, callback: string | null): void {
    Database.executeQuery(
      new Query(this.name, QueryType.FindOne, conditions, callback)
    );
  }
  ...
  public deleteOne(conditions: object, callback: string | null): void {
    Database.executeQuery(
      new Query(this.name, QueryType.DeleteOne, conditions, callback)
    );
  }
